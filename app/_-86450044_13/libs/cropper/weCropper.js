...
!function(e, o) {
    ...
    var r = void 0, c = [ "touchstarted", "touchmoved", "touchended" ], a = "function" == typeof Symbol && "symbol" === t(Symbol.iterator) ? function(e) {
        ...
        src: {
            ...
            set: function(t) {
                "string" != typeof t && console.error("id：" + t + " is invalid"), s.src = t;
            }
        },
        cut: {
            default: {},
    ...
    return Object.assign(g.prototype, h), g.prototype.prepare = function() {
        ...
        var t = this, e = t.deviceRadio, o = t.width, n = t.height, i = t.cut, r = i.x, c = void 0 === r ? 0 : r, a = i.y, u = void 0 === a ? 0 : a, d = i.width, l = void 0 === d ? o : d, s = i.height, f = void 0 === s ? n : s;
            ...
            switch (toString.call(n[0])) {
              ...
              case "[object Function]":
                wx.canvasToTempFilePath({
                    ...
                    fail: function(t) {
                        "function" == typeof n[n.length - 1] && n[n.length - 1]("fail");
                    }
                });
            }
            return t;
        ...
        var t = this, e = (t.deviceRadio, t.width), o = t.height, n = t.cut, i = n.x, r = void 0 === i ? 0 : i, c = n.y, a = void 0 === c ? 0 : c, u = n.width, d = void 0 === u ? e : u, l = n.height, s = void 0 === l ? o : l;
        t.outsideBound = function(e, o) {
            t.imgLeft = e >= r ? r : t.scaleWidth + e - r <= d ? r + d - t.scaleWidth : e, t.imgTop = o >= a ? a : t.scaleHeight + o - a <= s ? a + s - t.scaleHeight : o;
        }, t.setBoundStyle = function() {
            var n = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, i = n.color, c = void 0 === i ? "#04b00f" : i, u = n.mask, l = void 0 === u ? "rgba(0, 0, 0, 0.3)" : u, f = n.lineWidth, h = void 0 === f ? 1 : f;
            t.ctx.beginPath(), t.ctx.setFillStyle(l), t.ctx.fillRect(0, 0, r, o), t.ctx.fillRect(r, 0, d, a), 
            t.ctx.fillRect(r, a + s, d, o - a - s), t.ctx.fillRect(r + d, 0, e - r - d, o), 
            ...
            t.ctx.moveTo(r - h, a + s - 10 + h), t.ctx.lineTo(r - h, a + s + h), t.ctx.lineTo(r + 10 - h, a + s + h), 
            t.ctx.stroke(), t.ctx.beginPath(), t.ctx.setStrokeStyle(c), t.ctx.setLineWidth(h), 
            t.ctx.moveTo(r + d - 10 + h, a - h), t.ctx.lineTo(r + d + h, a - h), t.ctx.lineTo(r + d + h, a + 10 - h), 
            t.ctx.stroke(), t.ctx.beginPath(), t.ctx.setStrokeStyle(c), t.ctx.setLineWidth(h), 
            t.ctx.moveTo(r + d + h, a + s - 10 + h), t.ctx.lineTo(r + d + h, a + s + h), t.ctx.lineTo(r + d - 10 + h, a + s + h), 
            t.ctx.stroke();
        };
