...
function s(e) {
    var t = [];
    if (0 == a.length || !i) return (d = {}).node = "text", d.text = e, s = [ d ];
    e = e.replace(/\[([^\[\]]+)\]/g, ":$1:");
...
var n = "https", a = "", o = "", i = {}, l = require("79371034D69926BF1F517833CCF49EA6.js"), d = require("F8ACBA07D69926BF9ECAD200B5E49EA6.js"), c = (e("area,base,basefont,br,col,frame,hr,img,input,link,meta,param,embed,command,keygen,source,track,wbr"), 
        ...
        return d(e, {
            start: function(e, t, r) {
                ...
                0 !== t.length && (s.attr = t.reduce(function(e, t) {
                    ...
                    return "class" == r && (console.dir(n), s.classStr = n), "style" == r && (console.dir(n), 
