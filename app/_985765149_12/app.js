...
}(require("/7AF84DE7D69926BF1C9E25E010C49EA6.js")), o = require("./components/login/login"), s = require("/A93C6C17D69926BFCF5A041083A49EA6.js");
...
App((a = {
    ...
    getCode: function() {
        ...
        wx.login({
            success: function(t) {
                t.code ? (console.log(t.code), e.goLogin(t.code)) : wx.showModal({
                    title: "提示",
                    content: "获取用户信息超时，请重试",
                    showCancel: !1,
                    success: function(t) {
